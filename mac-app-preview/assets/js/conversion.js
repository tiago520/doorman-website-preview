...
if (topic && intent) {
  const labels = { macos: 'macos', mdm: 'mdm', team: 'team', security: 'security', deployment: 'deployment', enterprise: 'deployment', support: 'support', finance: 'finance', pricing: 'pricing', evals: 'quality', tune: 'tune', models: 'models', mcp: 'mcp', integrations: 'integrations', vibeguard: 'browser', sustainability: 'sustainability', assessment: 'assessment' };
...
if (topic) {
  const prompts = {
    ...
    'Managed Mac / MDM rollout': 'Share your MDM or self-service platform, Mac count, macOS versions, workspace and permission requirements.',
